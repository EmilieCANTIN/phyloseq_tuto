...
```
# On est censé avoir un graphe réseau mais un nouvel onglet s'ouvre sur une page toute blanche.
...
library(usethis)
use_git_config(user.name = "EmilieCANTIN", user.email = "ecantin77340@gmail.com")
```
